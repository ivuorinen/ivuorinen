...
- [ivuorinen/dotfiles](https://github.com/ivuorinen/dotfiles) ([25.2.24](https://github.com/ivuorinen/dotfiles/releases/tag/25.2.24), 1 day ago) - These are my dotfiles. There are many like &#39;em, but these are mine.
- [ivuorinen/base-configs](https://github.com/ivuorinen/base-configs) ([@ivuorinen/stylelint-config@0.3.15](https://github.com/ivuorinen/base-configs/releases/tag/%40ivuorinen/stylelint-config%400.3.15), 2 days ago) - A collection of base configs for code quality and linting tools. Heavily based on `@demartini/base-configs`
...
- [yankeexe/git-worktree-switcher](https://github.com/yankeexe/git-worktree-switcher) - Switch between git worktrees with speed. :zap: (1 day ago)
