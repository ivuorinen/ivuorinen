...
- [ivuorinen/business-data-fetcher](https://github.com/ivuorinen/business-data-fetcher) - PHP composer package API client to Finnish Patent and Registration Office&#39;s (PRH) Business Information System (BIS). (4 days ago)
...
- [ivuorinen/dotfiles](https://github.com/ivuorinen/dotfiles) ([24.10.17](https://github.com/ivuorinen/dotfiles/releases/tag/24.10.17), 1 day ago) - These are my dotfiles. There are many like &#39;em, but these are mine.
...
- [ivuorinen/base-configs](https://github.com/ivuorinen/base-configs) ([@ivuorinen/base-configs@2.0.4](https://github.com/ivuorinen/base-configs/releases/tag/%40ivuorinen/base-configs%402.0.4), 1 month ago) - A collection of base configs for code quality and linting tools. Heavily based on `@demartini/base-configs`
...
- [jrmoulton/tmux-sessionizer](https://github.com/jrmoulton/tmux-sessionizer) - Tmux Sessionizer: A tool for opening git repositories as tmux sessions (1 week ago)
- [LewisJEllis/awesome-lua](https://github.com/LewisJEllis/awesome-lua) - A curated list of quality Lua packages and resources. (1 week ago)
- [petertriho/nvim-scrollbar](https://github.com/petertriho/nvim-scrollbar) - Extensible Neovim Scrollbar (2 weeks ago)
- [Wansmer/treesj](https://github.com/Wansmer/treesj) - Neovim plugin for splitting/joining blocks of code (2 weeks ago)
