...
- [ivuorinen/dotfiles](https://github.com/ivuorinen/dotfiles) ([25.2.14](https://github.com/ivuorinen/dotfiles/releases/tag/25.2.14), 1 day ago) - These are my dotfiles. There are many like &#39;em, but these are mine.
...
- [jgusta/paths](https://github.com/jgusta/paths) - Program file locator plugin for Fish (1 day ago)
- [halostatue/fish-macos](https://github.com/halostatue/fish-macos) - MacOS functions for Fish (1 day ago)
- [x-motemen/ghq](https://github.com/x-motemen/ghq) - Remote repository management made easy (1 day ago)
- [jethrokuan/z](https://github.com/jethrokuan/z) - Pure-fish z directory jumping (1 day ago)
- [halostatue/fish-docker](https://github.com/halostatue/fish-docker) - Docker and Docker Compose completions for the Fish Shell (2 days ago)
