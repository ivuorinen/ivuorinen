...
- [ivuorinen/dotfiles](https://github.com/ivuorinen/dotfiles) ([25.2.27.2101](https://github.com/ivuorinen/dotfiles/releases/tag/25.2.27.2101), 1 day ago) - These are my dotfiles. There are many like &#39;em, but these are mine.
- [ivuorinen/base-configs](https://github.com/ivuorinen/base-configs) ([@ivuorinen/stylelint-config@0.3.15](https://github.com/ivuorinen/base-configs/releases/tag/%40ivuorinen/stylelint-config%400.3.15), 5 days ago) - A collection of base configs for code quality and linting tools. Heavily based on `@demartini/base-configs`
...
- [GitTools/GitVersion](https://github.com/GitTools/GitVersion) - From git log to SemVer in no time (1 day ago)
- [phpenv/phpenv](https://github.com/phpenv/phpenv) - Simple PHP version management (1 day ago)
- [browser-use/browser-use](https://github.com/browser-use/browser-use) - Make websites accessible for AI agents (2 days ago)
- [yankeexe/git-worktree-switcher](https://github.com/yankeexe/git-worktree-switcher) - Switch between git worktrees with speed. :zap: (4 days ago)
