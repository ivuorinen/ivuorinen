...
- [ivuorinen/dotfiles](https://github.com/ivuorinen/dotfiles) ([25.2.17](https://github.com/ivuorinen/dotfiles/releases/tag/25.2.17), 2 days ago) - These are my dotfiles. There are many like &#39;em, but these are mine.
- [ivuorinen/base-configs](https://github.com/ivuorinen/base-configs) ([@ivuorinen/semantic-release-config@0.3.14](https://github.com/ivuorinen/base-configs/releases/tag/%40ivuorinen/semantic-release-config%400.3.14), 2 days ago) - A collection of base configs for code quality and linting tools. Heavily based on `@demartini/base-configs`
...
- [Goldziher/kreuzberg](https://github.com/Goldziher/kreuzberg) - A text extraction library supporting PDFs, images, office documents and more (3 days ago)
- [jgusta/paths](https://github.com/jgusta/paths) - Program file locator plugin for Fish (5 days ago)
- [halostatue/fish-macos](https://github.com/halostatue/fish-macos) - MacOS functions for Fish (5 days ago)
- [x-motemen/ghq](https://github.com/x-motemen/ghq) - Remote repository management made easy (5 days ago)
