...
- [ivuorinen/docker-php-with-imagick](https://github.com/ivuorinen/docker-php-with-imagick) - PHP 7.4 with imagick for specific purposes (today)
...
- [ivuorinen/base-configs](https://github.com/ivuorinen/base-configs) ([@ivuorinen/stylelint-config@0.2.29](https://github.com/ivuorinen/base-configs/releases/tag/%40ivuorinen/stylelint-config%400.2.29), 1 day ago) - A collection of base configs for code quality and linting tools. Heavily based on `@demartini/base-configs`
- [ivuorinen/dotfiles](https://github.com/ivuorinen/dotfiles) ([24.6.20](https://github.com/ivuorinen/dotfiles/releases/tag/24.6.20), 3 days ago) - These are my dotfiles. There are many like &#39;em, but these are mine.
