...
- [ivuorinen/dotfiles](https://github.com/ivuorinen/dotfiles) ([24.8.19](https://github.com/ivuorinen/dotfiles/releases/tag/24.8.19), 1 day ago) - These are my dotfiles. There are many like &#39;em, but these are mine.
- [ivuorinen/base-configs](https://github.com/ivuorinen/base-configs) ([@ivuorinen/stylelint-config@0.2.37](https://github.com/ivuorinen/base-configs/releases/tag/%40ivuorinen/stylelint-config%400.2.37), 1 day ago) - A collection of base configs for code quality and linting tools. Heavily based on `@demartini/base-configs`
- [ivuorinen/business-data-fetcher](https://github.com/ivuorinen/business-data-fetcher) ([v1.1.0](https://github.com/ivuorinen/business-data-fetcher/releases/tag/v1.1.0), 1 day ago) - PHP composer package API client to Finnish Patent and Registration Office&#39;s (PRH) Business Information System (BIS).
...
- [code-lever/asdf-rust](https://github.com/code-lever/asdf-rust) - Rust plugin for the asdf version manager (6 days ago)
- [kefranabg/readme-md-generator](https://github.com/kefranabg/readme-md-generator) - 📄 CLI that generates beautiful README.md files (1 week ago)
- [ybiquitous/bem-ts](https://github.com/ybiquitous/bem-ts) - BEM class names generator for TypeScript (1 week ago)
- [cdleon/awesome-terminals](https://github.com/cdleon/awesome-terminals) - Terminal Emulators (1 week ago)
