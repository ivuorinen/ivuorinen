...
- [ivuorinen/dotfiles](https://github.com/ivuorinen/dotfiles) ([24.12.30](https://github.com/ivuorinen/dotfiles/releases/tag/24.12.30), 1 day ago) - These are my dotfiles. There are many like &#39;em, but these are mine.
...
- [ZeroQI/YouTube-Agent.bundle](https://github.com/ZeroQI/YouTube-Agent.bundle) - Plex Metadata Agent for Movies and TV Series libraries (2 days ago)
- [dotnet/cli-lab](https://github.com/dotnet/cli-lab) - A guided tool will be provided to enable the controlled clean up of a system such that only the desired versions of the Runtime and SDKs remain. (4 days ago)
- [sabre-io/vobject](https://github.com/sabre-io/vobject) -  :date: The VObject library for PHP allows you to easily parse and manipulate iCalendar and vCard objects (4 days ago)
- [ProtonMail/gluon](https://github.com/ProtonMail/gluon) - An IMAP server library written in Go (4 days ago)
