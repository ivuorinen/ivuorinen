...
- [ivuorinen/dotfiles](https://github.com/ivuorinen/dotfiles) ([24.10.22](https://github.com/ivuorinen/dotfiles/releases/tag/24.10.22), 1 day ago) - These are my dotfiles. There are many like &#39;em, but these are mine.
- [ivuorinen/base-configs](https://github.com/ivuorinen/base-configs) ([@ivuorinen/markdownlint-config@0.3.3](https://github.com/ivuorinen/base-configs/releases/tag/%40ivuorinen/markdownlint-config%400.3.3), 3 days ago) - A collection of base configs for code quality and linting tools. Heavily based on `@demartini/base-configs`
...
- [yuki-yano/tms](https://github.com/yuki-yano/tms) - tmux session manager for fzf (3 days ago)
