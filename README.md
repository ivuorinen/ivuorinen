...
- [ivuorinen/dotfiles](https://github.com/ivuorinen/dotfiles) ([24.9.19](https://github.com/ivuorinen/dotfiles/releases/tag/24.9.19), 2 days ago) - These are my dotfiles. There are many like &#39;em, but these are mine.
- [ivuorinen/base-configs](https://github.com/ivuorinen/base-configs) ([@ivuorinen/base-configs@2.0.4](https://github.com/ivuorinen/base-configs/releases/tag/%40ivuorinen/base-configs%402.0.4), 4 days ago) - A collection of base configs for code quality and linting tools. Heavily based on `@demartini/base-configs`
...
- [muesli/gitomatic](https://github.com/muesli/gitomatic) - A tool to monitor git repositories and automatically pull &amp; push changes (2 days ago)
- [storj/dbx](https://github.com/storj/dbx) - A neat codegen-based database wrapper written in Go  (3 days ago)
- [brettdottech/info-orbs](https://github.com/brettdottech/info-orbs) - An open sourced desk widget using esp32 and affordable round tft displays! (3 days ago)
...
- [adamcrews/asdf-tf-summarize](https://github.com/adamcrews/asdf-tf-summarize) - asdf plugin to install tf-summarize (3 days ago)
