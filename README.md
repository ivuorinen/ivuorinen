...
- [ivuorinen/dotfiles](https://github.com/ivuorinen/dotfiles) ([24.12.9](https://github.com/ivuorinen/dotfiles/releases/tag/24.12.9), 1 day ago) - These are my dotfiles. There are many like &#39;em, but these are mine.
- [ivuorinen/base-configs](https://github.com/ivuorinen/base-configs) ([@ivuorinen/browserslist-config@0.4.2](https://github.com/ivuorinen/base-configs/releases/tag/%40ivuorinen/browserslist-config%400.4.2), 1 day ago) - A collection of base configs for code quality and linting tools. Heavily based on `@demartini/base-configs`
...
- [step-security/harden-runner](https://github.com/step-security/harden-runner) - Network egress filtering and runtime security for GitHub-hosted and self-hosted runners (2 days ago)
- [nikitastupin/pwnhub](https://github.com/nikitastupin/pwnhub) - How GitHub Actions workflows can be hacked (2 days ago)
