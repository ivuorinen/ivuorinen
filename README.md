...
- [ivuorinen/dotfiles](https://github.com/ivuorinen/dotfiles) ([25.2.15](https://github.com/ivuorinen/dotfiles/releases/tag/25.2.15), 1 day ago) - These are my dotfiles. There are many like &#39;em, but these are mine.
- [ivuorinen/base-configs](https://github.com/ivuorinen/base-configs) ([@ivuorinen/browserslist-config@0.4.7](https://github.com/ivuorinen/base-configs/releases/tag/%40ivuorinen/browserslist-config%400.4.7), 2 weeks ago) - A collection of base configs for code quality and linting tools. Heavily based on `@demartini/base-configs`
...
- [jgusta/paths](https://github.com/jgusta/paths) - Program file locator plugin for Fish (2 days ago)
- [halostatue/fish-macos](https://github.com/halostatue/fish-macos) - MacOS functions for Fish (2 days ago)
- [x-motemen/ghq](https://github.com/x-motemen/ghq) - Remote repository management made easy (2 days ago)
- [jethrokuan/z](https://github.com/jethrokuan/z) - Pure-fish z directory jumping (2 days ago)
- [halostatue/fish-docker](https://github.com/halostatue/fish-docker) - Docker and Docker Compose completions for the Fish Shell (3 days ago)
