...
- [ivuorinen/dotfiles](https://github.com/ivuorinen/dotfiles) ([25.4.11](https://github.com/ivuorinen/dotfiles/releases/tag/25.4.11), 3 days ago) - These are my dotfiles. There are many like &#39;em, but these are mine.
- [ivuorinen/base-configs](https://github.com/ivuorinen/base-configs) ([@ivuorinen/stylelint-config@0.3.16](https://github.com/ivuorinen/base-configs/releases/tag/%40ivuorinen/stylelint-config%400.3.16), 3 days ago) - A collection of base configs for code quality and linting tools. Heavily based on `@demartini/base-configs`
- [ivuorinen/actions](https://github.com/ivuorinen/actions) ([25.4.8](https://github.com/ivuorinen/actions/releases/tag/25.4.8), 6 days ago) - ivuorinen&#39;s shared actions
...
- [nvimdev/guard.nvim](https://github.com/nvimdev/guard.nvim) - Lightweight, fast and async formatting and linting plugin for Neovim (6 days ago)
